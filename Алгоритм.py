...
classes = [ 
        ...
        { 
            ...
            "subjects": [ 
                ...
                {"name": "Общество/Музыка", "teacher": ('Пятибратова К.В.',), "hours": 2}, 
...
povtor = {
    ...
    "9В": {
        ...
        'Наумова М.В.' : [
            ["Алгебра", 4], ["Теор вер", 1],  ["Геометрия", 3]
        ],
    ...
    "10Б": {
        ...
        'Размашкин В.Н.' : [
            ["Алгебра", 4], ["Теор вер", 1],  ["Геометрия", 3], ["ИП", 1]
        ],
    },
    ...
    "11Б": {
        'Размашкин В.Н.' : [
            ["Алгебра", 4], ["Геометрия", 3], ["Теор вер", 1]
        ],
    },
